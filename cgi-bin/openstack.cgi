...
# openstack.cgi -
#
# Get/set EC-OpenStack configuration info for UI
#
...
# CLEANUP: CHECK
#
# Copyright (c) 2007-2012 Electric Cloud, Inc.
# All rights reserved
################################
...
################################
# getCfgList - Return the list of configurations from OpenStack
#
# Arguments:
#   -
#
...
sub getCfgList {
    ...
    my $gcfg = new ElectricCommander::PropDB($::ec,"/projects/@PLUGIN_NAME@/openstack_cfgs");
    ...
    foreach my $cfg (keys  %cfgs) {
        my $url = $gcfg->getCol("$cfg/service_url");
        $xml .= "  <cfg>\n";
        $xml .= "     <name>$cfg</name>\n";
