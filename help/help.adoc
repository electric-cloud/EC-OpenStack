...
+
.Deploy output
image::cloudbees-common::cd-plugins/ec-openstack/use-cases/case-1/deploy-log.png[Deploy output,role="screenshot"]
+
.Cleanup output
image::cloudbees-common::cd-plugins/ec-openstack/use-cases/case-1/cleanup-log.png[Cleanup output,role="screenshot"]
