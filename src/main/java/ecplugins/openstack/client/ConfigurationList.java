...
/**
 * EC-OpenStack Configuration List.
 */
    ...
    extends ListBase
{
    ...
    private OpenStackConfigList m_configList;

    //~ Constructors -----------------------------------------------------------

    public ConfigurationList()
    {
        super("ecgc", "OpenStack Configurations", "All Configurations");
        m_configList = new OpenStackConfigList();
    }
    ...
    @Override protected void load()
    {
        ...
        OpenStackConfigListLoader loader = new OpenStackConfigListLoader(m_configList, this,
                new ChainedCallback() {
    ...
    private void deleteConfiguration(String configName)
    {
        ...
        request.setProjectName("/plugins/EC-OpenStack/project");
        ...
        for (String configName : m_configList.getConfigNames()) {
            ...
            DialogClickHandler dch              = new DialogClickHandler(
                    new DeleteConfirmationDialog(configName,
                        "Are you sure you want to delete the OpenStack configuration '"
                            + configName + "'?") {
    ...
    private void waitForJob(final String jobId)
    {
        CgiRequestProxy     cgiRequestProxy = new CgiRequestProxy(
                getPluginName(), "openstackMonitor.cgi");
